              ...
              return (
                <Link
                  ...
                  className={`flex items-center space-x-1 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${
                    isActive
                      ? 'text-brand-700 bg-brand-50/60 dark:text-brand-400 dark:bg-brand-950/20'
                      : 'text-slate-600 dark:text-slate-350 hover:text-brand-600 dark:hover:text-brand-400 hover:bg-slate-100/50 dark:hover:bg-slate-900/40'
                  }`}
                >
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            {isAuthenticated ? (
              ...
              <div className="flex items-center space-x-3 border-l border-slate-200 dark:border-slate-800 pl-4">
                <Link
                  href="/login"
                  className="text-sm font-semibold text-slate-700 dark:text-slate-350 hover:text-brand-600 dark:hover:text-brand-400 px-3 py-2 transition-all"
                >
                  Login
                </Link>
                <Link
            ...
            return (
              <Link
                ...
                className={`flex items-center space-x-2 px-3 py-3 rounded-lg text-base font-medium transition-all ${
                  isActive
                    ? 'text-brand-700 bg-brand-50 dark:text-brand-450 dark:bg-brand-950/20'
                    : 'text-slate-600 dark:text-slate-350 hover:bg-slate-55 dark:hover:bg-slate-900'
                }`}
              >
