...
def build_and_train():
    print("Step 1: Loading patient risk assessment data...")
    ...
    # Check data balance
    print(f"Original class distribution: {df['Risk_Level'].value_counts().to_dict()}")
    ...
    print("Step 3: Balancing classes via SMOTE...")
    ...
    print("Step 4: Training baseline Logistic Regression...")
    lr_baseline = LogisticRegression(max_iter=1000, random_state=42)
    lr_baseline.fit(X_train_balanced, y_train_balanced)
    y_pred_lr = lr_baseline.predict(X_test)
    lr_f1 = f1_score(y_test, y_pred_lr, average="weighted")
    print(f"Logistic Regression Baseline Weighted F1: {lr_f1:.4f}")
    
    # 7. Optimize Random Forest using Optuna
    print("Step 5: Optimizing Random Forest Classifier...")
    ...
    print(f"Best Random Forest F1: {rf_study.best_value:.4f}")
    ...
    print("Step 6: Optimizing XGBoost Classifier...")
    ...
    print("Saved evaluation report to reports/model_evaluation.json")
    ...
    print("Saved best model and preprocessor to backend/ml/saved_models/")
